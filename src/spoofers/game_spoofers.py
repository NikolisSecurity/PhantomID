...
class GameSpoofer:
    ...
    def modify_registry_value(self, key_path: str, value_name: str, new_value: str, 
        ...
        try:
            ...
            backup_name = f"{key_path.replace('\\', '_')}_{value_name}"
            ...
            self.logger.info(f"Registry modified: {key_path}\\{value_name} = {new_value}")
            return True
...
class AntiDetectionManager:
    ...
    def clear_system_traces(self):
        ...
        try:
            recent_path = os.path.expandvars("%userprofile%\\Recent")
